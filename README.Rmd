...
* Basic statistics
    ...
    + `calc_seg_sites()`: Rarefaction-corrected estiamtes of the number of segregating sites per facet level.
...
* Site-frequency Spectra:
    ...
    + `calc_origin_of_expansion()`: Estimate the origin point of a range expansion based directionality.
* Other:
...
* `calc_tajimas_d()`: Tajima's D across sliding windows or globally. Also calculates Watterson's and Tajima's theta.
* Bootstrapping:
