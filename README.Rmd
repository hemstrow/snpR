...
* Basic statistics
    ...
    + `calc_roh()`: Run-of-Homozygosity detection and $F_{ROH}$ calculation.
...
* `plot_sfs()`: Plots site frequency spectra either from pre-consturcted SFS or directly from `snpRdata` object.
