...
snpR has a workflow to export snpRdata objects for parentage assignment using COLONY (citation) or runnin natively in R using Sequoia (citation)!

function write.colony
function run_sequoia
function pedigree
