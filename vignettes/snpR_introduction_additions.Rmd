...
# not running this code for simplicity
...
Assignment results from COLONY or sequoia can be plotted using a handful of packages. Here we have chosen to use visPedigree () which has a native R integration. 
