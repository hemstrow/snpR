...
get.snpR.stats will automatically return multiple types of data if it is available. Typically, this is the statistic calculated both within each individual snp and the weighted averages within populaitons (or facet levels).
...
```{r}
sub4 <- my.dat[pop.fam = "ASP.A"]
head(sample.meta(sub4))

# sub5 <- my.dat[pop.fam = "A.ASP"] # won't work
